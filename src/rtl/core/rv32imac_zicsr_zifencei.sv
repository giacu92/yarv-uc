 ...
 *
 * Each bridge is a per-port FSM (read + write independent) so the
 * pipeline sees one-cycle request/response semantics, and the rest of
 * the system sees the CPU as a plain AXI4-Lite master.
 *
